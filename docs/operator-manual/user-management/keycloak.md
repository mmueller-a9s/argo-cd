...
Also you can set __Home URL__ to _/applications_.

The Valid Redirect URIs should be set to https://{hostname}/oauth2/callback (you can also set the less secure https://{hostname}/* for testing/development purposes,
